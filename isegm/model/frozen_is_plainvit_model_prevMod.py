...
from isegm.model.frozen_is_model_prevMod import ISModel_prevMod
...
class PlainVitModel_prevMod(ISModel_prevMod):
    ...
    def frozen_vit_backbone_forward(self, image, coord_features=None):
        with torch.no_grad():
            ...
            backbone_features, early_features = self.backbone.forward_backbone(image, coord_features, self.random_split, True, [2,3])
        ...
        return early_features, backbone_features, multi_scale_features
