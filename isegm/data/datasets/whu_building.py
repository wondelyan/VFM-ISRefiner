...
class WHUBuildingTestDataset(ISDataset):
    def __init__(self, dataset_path, **kwargs):
        super(WHUBuildingTestDataset, self).__init__(**kwargs)
    ...
    def load_samples(self):
        self.labels_path = self.dataset_path / 'label_use' 
        self.images_path = self.dataset_path / 'image_use'
