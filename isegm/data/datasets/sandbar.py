...
class SandBarDataset(ISDataset):
    def __init__(self, dataset_path, split='train', **kwargs):
        super(SandBarDataset, self).__init__(**kwargs)
    ...
    def load_samples(self):
        self.labels_path = self.dataset_path / 'masks' / self.split
        self.images_path = self.dataset_path / 'images' / self.split
