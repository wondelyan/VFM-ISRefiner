...
class ISPRSVaihingenDataset(ISDataset):
    def __init__(self, dataset_path, split='train_rgb', **kwargs):
        super(ISPRSVaihingenDataset, self).__init__(**kwargs)
        self.split = split
    ...
    def load_samples(self):
        self.labels_path = self.dataset_path / 'ann_dir' / self.split
        self.images_path = self.dataset_path / 'img_dir' / self.split
